  ...
  methods: {
    login: function login() {
      ...
      (0, _axios.default)({
        ...
        _this.isError = err.response.data.msg;
      });
    },
...
exports.default = _default;
        var $fc3b75 = exports.default || module.exports;
      
      if (typeof $fc3b75 === 'function') {
        $fc3b75 = $fc3b75.options;
      }
    
        /* template */
        Object.assign($fc3b75, (function () {
          var render = function() {
  var _vm = this
  ...
  return _c("div", [
    ...
    _c("div", { staticClass: "container" }, [
      _c("div", { staticClass: "d-flex row justify-content-center mt-5" }, [
        _c(
          "div",
          { staticClass: "card p-5 bg-info", staticStyle: { opacity: "95%" } },
          [
            _c(
              "h2",
              {
                staticClass: "mb-4 text-body",
                  ...
                  "a",
                  {
                    ...
                    on: {
                      click: function($event) {
                        $event.preventDefault()
                        return _vm.changeRegister($event)
                      }
                    }
                  },
...
var staticRenderFns = [
  function() {
    ...
    return _c(
      ...
      {
        staticClass: "mt-5",
        staticStyle: { "text-align": "center", "font-family": "monospace" }
      },
      [_c("h1", [_vm._v("Welcome, to Kangban !")])]
    )
  }
]
    ...
    (function () {
      if (module.hot) {
        ...
        if (api.compatible) {
          module.hot.accept();
          if (!module.hot.data) {
            api.createRecord('$fc3b75', $fc3b75);
          } else {
            api.reload('$fc3b75', $fc3b75);
          }
        }
...
},{"axios":"node_modules/axios/index.js","_css_loader":"../../../../../../../usr/local/lib/node_modules/parcel-bundler/src/builtins/css-loader.js","vue-hot-reload-api":"node_modules/vue-hot-reload-api/dist/index.js","vue":"node_modules/vue/dist/vue.runtime.esm.js"}],"src/components/register.vue":[function(require,module,exports) {
"use strict";
...
var _default = {
    ...
    registerForm: function registerForm() {
      ...
      if (this.password_register !== this.confirmpassword_register) {
        ...
        (0, _axios.default)({
          ...
          localStorage.setItem('token', response.data); // this.isLogin = localStorage.getItem('token')
  ...
  watch: {
    password_register: function password_register() {
      this.isError = null;
    },
    confirmpassword_register: function confirmpassword_register() {
      this.isError = null;
    }
  }
};
exports.default = _default;
        var $d5255a = exports.default || module.exports;
      
      if (typeof $d5255a === 'function') {
        $d5255a = $d5255a.options;
      }
    
        /* template */
        Object.assign($d5255a, (function () {
          var render = function() {
  var _vm = this
  var _h = _vm.$createElement
  var _c = _vm._self._c || _h
          ...
          [
            ...
            _c(
              ...
              [
                ...
                _vm._v(" "),
                _c("div", { staticClass: "form-group" }, [
                  _c("label", { attrs: { for: "email_register" } }, [
                    _vm._v("Email address:")
                  ]),
                  _vm._v(" "),
                  _c("input", {
                ...
                _vm._v(" "),
                _c("div", { staticClass: "form-group" }, [
                  _c("label", { attrs: { for: "name_register" } }, [
                    _vm._v("Name:")
                  ]),
                  _vm._v(" "),
                  _c("input", {
                ...
                _vm._v(" "),
                _c("div", { staticClass: "form-group" }, [
                  _c("label", { attrs: { for: "confirmpassword_register" } }, [
                    ...
                    directives: [
                      {
                        name: "model",
                        rawName: "v-model",
                        value: _vm.confirmpassword_register,
                        expression: "confirmpassword_register"
                      }
                    ],
                    staticClass: "form-control",
                    attrs: { type: "password", required: "" },
                    domProps: { value: _vm.confirmpassword_register },
                    on: {
                      input: function($event) {
                        if ($event.target.composing) {
                          return
                        }
                        _vm.confirmpassword_register = $event.target.value
                      }
                    }
                  })
                ]),
    ...
    (function () {
      if (module.hot) {
        ...
        if (api.compatible) {
          module.hot.accept();
          if (!module.hot.data) {
            api.createRecord('$d5255a', $d5255a);
          } else {
            api.reload('$d5255a', $d5255a);
          }
        }
...
},{"axios":"node_modules/axios/index.js","_css_loader":"../../../../../../../usr/local/lib/node_modules/parcel-bundler/src/builtins/css-loader.js","vue-hot-reload-api":"node_modules/vue-hot-reload-api/dist/index.js","vue":"node_modules/vue/dist/vue.runtime.esm.js"}],"src/components/navbar.vue":[function(require,module,exports) {
"use strict";
...
exports.default = _default;
        var $5c89cd = exports.default || module.exports;
      
      if (typeof $5c89cd === 'function') {
        $5c89cd = $5c89cd.options;
      }
    
        /* template */
        Object.assign($5c89cd, (function () {
          var render = function() {
  var _vm = this
  var _h = _vm.$createElement
  var _c = _vm._self._c || _h
    ...
    (function () {
      if (module.hot) {
        ...
        if (api.compatible) {
          module.hot.accept();
          if (!module.hot.data) {
            api.createRecord('$5c89cd', $5c89cd);
          } else {
            api.reload('$5c89cd', $5c89cd);
          }
        }
...
var _default = {
  ...
  methods: {
    ...
    logout: function logout() {
      localStorage.removeItem('token'); // this.isLogin = localStorage.getItem('token')
    ...
    deleteTask: function deleteTask(id) {
      ...
      (0, _axios.default)({
        method: 'delete',
        url: "http://localhost:3000/tasks/delete/".concat(id),
        headers: {
          access_token: localStorage.getItem('token')
        }
      }).then(function (response) {
    ...
    switchRight: function switchRight(id, category) {
      var _this3 = this;
    ...
    switchLeft: function switchLeft(id, category) {
      var _this4 = this;
...
exports.default = _default;
        var $25bc71 = exports.default || module.exports;
      
      if (typeof $25bc71 === 'function') {
        $25bc71 = $25bc71.options;
      }
    
        /* template */
        Object.assign($25bc71, (function () {
          var render = function() {
  var _vm = this
  var _h = _vm.$createElement
  var _c = _vm._self._c || _h
  return _c("div", [
    _vm.page === "mainPage"
      ? _c("div", [_c("navbar", { on: { logout: _vm.logout } })], 1)
      : _vm._e(),
    _vm._v(" "),
    _vm.page === "loginPage"
      ? _c(
          ...
          [
            _c("login", {
              on: { changePage: _vm.changePage, refresh: _vm.refresh }
            })
          ],
          1
        )
    ...
    _vm.page === "registerPage"
      ? _c("div", [_c("register", { on: { changePage: _vm.changePage } })], 1)
      : _vm._e(),
    _vm._v(" "),
    _vm.page === "mainPage"
      ? _c("div", [
          _c("div", { staticClass: "container mt-5" }, [
            ...
            _c("div", { staticClass: "d-flex flex-row" }, [
              _c(
                "div",
                {
                  staticClass: "card col-3 mr-3 pb-3",
                  staticStyle: {
                    "text-align": "center",
                ...
                [
                  ...
                  _c(
                    ...
                    _vm._l(_vm.dataBacklog, function(task) {
                      return _c(
                        "div",
                        { key: task.id, staticClass: "card mb-2" },
                        [
                          _c("div", { staticClass: "card-body mb-1" }, [
              ...
              _c(
                "div",
                {
                  staticClass: "card col-3 bg-warning mr-3 pb-3",
                ...
                [
                  ...
                  _c(
                    ...
                    _vm._l(_vm.dataTodo, function(task) {
                      return _c(
                        "div",
                        { key: task.id, staticClass: "card mb-2" },
                        [
              ...
              _c(
                "div",
                {
                  staticClass: "card col-3 bg-primary mr-3 pb-3",
                  staticStyle: { "text-align": "center", height: "100%" }
                },
                [
                  _vm._m(2),
                  ...
                  _c(
                    ...
                    _vm._l(_vm.dataDone, function(task) {
                      return _c(
                        "div",
                        { key: task.id, staticClass: "card mb-2" },
                        [
              ...
              _c(
                "div",
                {
                  staticClass: "card col-3 bg-success pb-3",
                  staticStyle: {
                    "text-align": "center",
                    height: "100%",
                    opacity: "93%"
                ...
                [
                  ...
                  _c(
                    ...
                    _vm._l(_vm.dataCompleted, function(task) {
                      return _c(
                        "div",
                        { key: task.id, staticClass: "card mb-2" },
                        [
...
var staticRenderFns = [
  function() {
    ...
    var _h = _vm.$createElement
    var _c = _vm._self._c || _h
    return _c("div", { staticClass: "mt-2" }, [_c("h4", [_vm._v("Back-Log")])])
  },
  function() {
    var _vm = this
    var _h = _vm.$createElement
    var _c = _vm._self._c || _h
    return _c("div", { staticClass: "mt-2" }, [_c("h4", [_vm._v("Todo")])])
  },
  function() {
    var _vm = this
    var _h = _vm.$createElement
    var _c = _vm._self._c || _h
    return _c("div", { staticClass: "mt-2" }, [_c("h4", [_vm._v("Done")])])
  },
  function() {
    var _vm = this
    var _h = _vm.$createElement
    var _c = _vm._self._c || _h
    return _c("div", { staticClass: "mt-2" }, [_c("h4", [_vm._v("Completed")])])
  }
]
render._withStripped = true
    ...
    (function () {
      if (module.hot) {
        ...
        if (api.compatible) {
          module.hot.accept();
          if (!module.hot.data) {
            api.createRecord('$25bc71', $25bc71);
          } else {
            api.reload('$25bc71', $25bc71);
          }
        }
...
},{"axios":"node_modules/axios/index.js","./components/login":"src/components/login.vue","./components/register":"src/components/register.vue","./components/navbar":"src/components/navbar.vue","_css_loader":"../../../../../../../usr/local/lib/node_modules/parcel-bundler/src/builtins/css-loader.js","vue-hot-reload-api":"node_modules/vue-hot-reload-api/dist/index.js","vue":"node_modules/vue/dist/vue.runtime.esm.js"}],"src/main.js":[function(require,module,exports) {
"use strict";
